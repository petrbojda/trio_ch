...
def grid_plot_histograms(lst_det_left, lst_det_right, beams_tp, mcc_start, mcc_end, fname_det):
    """
    ...
    #################### Left radar plot
    if lst_det_left:
        LR_data = lst_det_left.get_array_detections_selected(mcc=(mcc_start, mcc_end))
        f1ax[2].hist(LR_data["velocity"], vel_range, color=color_map_left(0.4), normed=1)
        number_of_dets_left = np.size(LR_data["mcc"])

        if beams_tp.count(0):
            LR0_data = lst_det_left.get_array_detections_selected(beam=[0],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(1):
            LR1_data = lst_det_left.get_array_detections_selected(beam=[1],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(2):
            LR2_data = lst_det_left.get_array_detections_selected(beam=[2],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(3):
            LR3_data = lst_det_left.get_array_detections_selected(beam=[3],mcc=(mcc_start, mcc_end))
    ...
    #################### Right radar plot
    if lst_det_right:
        RR_data = lst_det_right.get_array_detections_selected(mcc=(mcc_start, mcc_end))
        f1ax[4].hist(RR_data["velocity"], vel_range, color=color_map_left(0.4), normed=1)
        number_of_dets_right = np.size(RR_data["mcc"])

        if beams_tp.count(0):
            RR0_data = lst_det_right.get_array_detections_selected(beam=[0],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(1):
            RR1_data = lst_det_right.get_array_detections_selected(beam=[1],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(2):
            RR2_data = lst_det_right.get_array_detections_selected(beam=[2],mcc=(mcc_start, mcc_end))
        ...
        if beams_tp.count(3):
            RR3_data = lst_det_right.get_array_detections_selected(beam=[3],mcc=(mcc_start, mcc_end))
    ...
    tit = "MCC: %08d Num of Det: L=%d R=%d In Selected Beams: L=%d R=%d" % (mcc_start,
                                                                            number_of_dets_left,
...
def static_plot(lst_det_left, lst_det_right, beams_tp, fname_det):
    """
